...
virtualenv --system-site-packages /home/vagrant/forums-env
echo "source /home/vagrant/forums-env/bin/activate" >> /home/vagrant/.profile
source /home/vagrant/forums-env/bin/activate
cd /vagrant
